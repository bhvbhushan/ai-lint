...
- **Missing dist/context.js in npm package** — `prepublishOnly` now runs `build:context` so `dist/context.js` is actually included in the published tarball (was missing in 0.4.1 and 0.4.2)
